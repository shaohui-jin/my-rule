...
import { InputData, OutputData } from '@/types/workflow'
...
//             configData:
//               '{"className":"get-part-children-deep-v2","path":"abstract-functions-v2/general","funcLuaName":"get_part_children_deep_v2","input":{"widgetList":[{"id":"input_part","type":"input","attributes":{"label":"输入的part对象","placeholder":"请输入输入的part对象","disabled":true,"paramType":"table","paramSubType":"{}Part"}},{"id":"deep","type":"inputNumber","defaultValue":1,"attributes":{"label":"深度","placeholder":"请输入深度","paramType":"number","inputType":"number"}},{"id":"expression","type":"function","attributes":{"label":"表达式","placeholder":"请输入表达式","paramType":"function"}}]},"output":{"widgetList":[{"type":"input","attributes":{"label":"结果列表","placeholder":"请输入结果列表","disabled":true,"paramType":"table","paramSubType":"Part[]"}}]}}',
//             luaScript:
...
//             funcDirectory: '',
//             configData:
//               '{"className":"print-result","funcLuaName":"print_result","input":{"widgetList":[{"id":"value","type":"input","attributes":{"label":"输入值","placeholder":"请输入输入值","paramType":"string"}}]},"output":{"widgetList":[{"type":"input","attributes":{"label":"输出值","placeholder":"请输入输出值","paramType":"string"}}]}}',
//             luaScript:
...
//             funcDirectory: 'abstract-functions-v2/general',
//             configData:
//               '{"className":"get-part-texture-attribute-v2","path":"abstract-functions-v2/general","funcLuaName":"get_part_texture_attribute_v2","input":{"widgetList":[{"id":"part","type":"input","attributes":{"label":"输入的Part","placeholder":"请输入输入的Part","disabled":true,"paramType":"table","paramSubType":"{}Part"}},{"id":"part_attr","type":"input","attributes":{"label":"模型属性","placeholder":"请输入模型属性","paramType":"string"}},{"id":"texture_attr","type":"input","attributes":{"label":"材质属性","placeholder":"请输入材质属性","paramType":"string"}}]},"output":{"widgetList":[{"type":"input","attributes":{"label":"输出值","placeholder":"请输入输出值","paramType":"string"}}]}}',
//             luaScript:
...
//             funcDirectory: 'abstract-functions-v2/general',
//             configData:
//               '{"className":"merge-strings-v2","path":"abstract-functions-v2/general","funcLuaName":"merge_strings_v2","input":{"widgetList":[{"id":"strings","type":"input","defaultValue":[],"attributes":{"label":"输入值","placeholder":"请输入输入值","disabled":true,"paramType":"table","paramSubType":"string[]"}},{"id":"separator","type":"input","attributes":{"label":"分隔符号","placeholder":"请输入分隔符号","paramType":"string"}},{"id":"merge_type","type":"select","defaultValue":0,"options":[{"label":"去重","value":0,"type":"number"},{"label":"去重并汇总","value":1,"type":"number"},{"label":"不去重","value":2,"type":"number"}],"attributes":{"label":"转换类型","placeholder":"请输入转换类型","paramType":"number"}},{"id":"count_prefix","type":"input","attributes":{"label":"数量前缀","placeholder":"请输入数量前缀","paramType":"string"}}]},"output":{"widgetList":[{"type":"input","attributes":{"label":"拼接后的字符串","placeholder":"请输入拼接后的字符串","paramType":"string"}}]}}',
//             luaScript:
...
//             funcDirectory: 'split-order',
//             configData:
//               '{"className":"split-order-single","path":"split-order","funcLuaName":"split_order_single","input":{"widgetList":[{"id":"context","type":"input","attributes":{"label":"输入上下文","placeholder":"请输入输入上下文","paramType":"any"}}]},"output":{"widgetList":[{"type":"input","attributes":{"label":"输出上下文","placeholder":"请输入输出上下文","paramType":"any"}}]}}',
//             luaScript:
...
//             funcDirectory: 'split-order',
//             configData:
//               '{"className":"split-order-by-roomId-and-touch","path":"split-order","funcLuaName":"split_order_by_roomId_and_touch","input":{"widgetList":[{"id":"context","type":"input","attributes":{"label":"输入上下文","placeholder":"请输入输入上下文","paramType":"any"}},{"id":"distance","type":"inputNumber","attributes":{"label":"判断是否挨着的距离阈值","placeholder":"请输入判断是否挨着的距离阈值","paramType":"number","inputType":"number"}}]},"output":{"widgetList":[{"type":"input","attributes":{"label":"输出上下文","placeholder":"请输入输出上下文","paramType":"any"}}]}}',
//             luaScript:
...
//             funcDirectory: 'split-order',
//             configData:
//               '{"className":"split-order-by-roomId","path":"split-order","funcLuaName":"split_order_by_roomId","input":{"widgetList":[{"id":"context","type":"input","attributes":{"label":"输入上下文","placeholder":"请输入输入上下文","paramType":"any"}}]},"output":{"widgetList":[{"type":"input","attributes":{"label":"输出上下文","placeholder":"请输入输出上下文","paramType":"any"}}]}}',
//             luaScript:
...
//             funcDirectory: 'split-order',
//             configData:
//               '{"className":"split-order-by-texture","path":"split-order","funcLuaName":"split_order_by_texture","input":{"widgetList":[{"id":"context","type":"input","attributes":{"label":"输入上下文","placeholder":"请输入输入上下文","paramType":"any"}}]},"output":{"widgetList":[{"type":"input","attributes":{"label":"输出上下文","placeholder":"请输入输出上下文","paramType":"any"}}]}}',
//             luaScript:
...
//             funcDirectory: '',
//             configData:
//               '{"className":"split-order-default","funcLuaName":"split_order_default","input":{"widgetList":[{"id":"context","type":"input","attributes":{"label":"输入上下文","placeholder":"请输入输入上下文","paramType":"any"}}]},"output":{"widgetList":[{"type":"input","attributes":{"label":"输出上下文","placeholder":"请输入输出上下文","paramType":"any"}}]}}',
//             luaScript:
