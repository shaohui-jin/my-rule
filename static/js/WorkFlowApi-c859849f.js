...
\r
return _M`,remark:"保留字段",functionStatus:"ENABLED",isGeometry:0,funcClassifyFullPath:null,enableTime:1751420135e3,pos:7,categoryId:-1,isDelete:0,createTime:1751420135e3,modifyTime:1758107208e3,creator:131,creatorName:"11051352",modifier:476,modifierName:"11051352",usageCount:null}]}],error:null}}async function C(t){const e=await d.post({url:"/rule-config/func/batchDetail",data:{funcIds:t}});return e.success?e.data:(l.error(e.message),[])}async function T(t,e,r,n,o,c){var p,u,s;const _=JSON.stringify(e),m=e.nodeList;for(let i of m)i.title==="决策表"&&((s=(u=(p=i.decisionTableData)==null?void 0:p.expressionConfig)==null?void 0:u.children)!=null&&s.length)&&o.push(i.decisionTableData.expressionConfig);const b=JSON.stringify(o),a=await d.post({url:"/rule-config/rule/update/config",data:{id:t,configData:_,luaScript:r,funcIds:n,variableSet:b,modifyReason:c}});return a.success?(l.success("规则更新成功"),a.data):(l.error(a.message),!1)}function I(t){const e={icon:"icon-func",type:"func",title:t.funcName,funcId:t.id,remark:t.funcDesc,inputData:[],outputData:[],logicData:{},path:"",className:"",funcName:""};let r;try{const n=JSON.parse(t.configData);r=g(n),e.inputData=(r==null?void 0:r.input)||[],e.outputData=(r==null?void 0:r.output)||[],e.logicData=(r==null?void 0:r.logicData)||{},e.path=(r==null?void 0:r.path)||"",e.className=(r==null?void 0:r.className)||"",e.funcName=(r==null?void 0:r.funcLuaName)||""}catch{console.error("解析函数配置数据失败: "+t.funcName+"  配置数据不满足要求")}return e}export{C as a,v as g,I as t,T as u};
